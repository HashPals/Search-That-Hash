...
class md5crypt:
	...
	supports = set(["md5", "md4", "ntlm", "sha-1", "sha-256", "sha384", "sha512", "ntlm"])
...
class opcrack:
	...
	def crack(self, hash):
		try:
			...
			burp0_json={"value": "0CB6948805F797BF2A82807973B89537"}

			text = requests.post(burp0_url, headers=burp0_headers, json=burp0_json).text
